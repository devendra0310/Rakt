  ...
  return (
    <div className='px-44'>
      ...
      <p className='text-right text-5xl'>
        <br />
        <a target="_blank" href="https://github.com/devendra0310" className='hover:drop-shadow-md hover:text-purple'><i class="fa-brands fa-github"></i></a>&nbsp;&nbsp;&nbsp;
        <a target="_blank" href="https://in.linkedin.com/in/devendra-singh-625783263" className='hover:drop-shadow-md hover:text-metal'><i class="fa-brands fa-linkedin"></i> </a>&nbsp;&nbsp;
      </p>
    </div>
  )
}
